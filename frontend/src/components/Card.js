    ...
    <li className="elements__container">
      ...
      <div className="elements__text-container">
        ...
        <div className="elements__heart-container">
          ...
          />
          <p className="elements__text elements__heart-number">
            {card.likes.length}
          </p>
        </div>
      </div>
